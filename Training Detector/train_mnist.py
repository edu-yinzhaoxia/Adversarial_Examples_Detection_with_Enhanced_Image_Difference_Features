...
def main():
    ...
    data_root = os.path.abspath(os.path.join(os.getcwd(), "F:/ae/ex-mnist/"))  # get data root path
    image_path = os.path.join(data_root, "mnist")  # flower data set path
    ...
    with open('class_mnist.json', 'w') as json_file:
